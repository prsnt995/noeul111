      ...
      <div className="container" style={{ maxWidth: '900px', margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ fontSize: '0.9375rem', lineHeight: 1.85, color: 'var(--text-secondary)' }}>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <div style={{ backgroundColor: 'var(--bg-secondary)', borderRadius: '8px', padding: '20px', border: '1px solid var(--border-light)', display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border-light)', paddingBottom: '10px' }}>
                <span style={{ color: 'var(--text-primary)', fontWeight: 600 }}>전국 무료배송 기준</span>
                <span style={{ color: 'var(--accent-sunset, #e05638)', fontWeight: 700, fontSize: '1.0625rem' }}>실결제 금액 70,000원 이상 구매 시</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border-light)', paddingBottom: '10px' }}>
                <span style={{ color: 'var(--text-primary)', fontWeight: 600 }}>기본 배송비</span>
                <span style={{ color: 'var(--text-primary)', fontWeight: 600 }}>3,000원 (70,000원 미만 구매 시)</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ color: 'var(--text-primary)', fontWeight: 600 }}>제주 및 도서산간 추가 배송비</span>
                <span style={{ color: 'var(--text-muted)' }}>[수정 가능 예시 - 3,000원 추가]</span>
              </div>
            </div>
          </section>
